...
public class OpenMMAmoebaLibrary implements Library {
	...
	/** Original signature : <code>int OpenMM_AmoebaGeneralizedKirkwoodForce_getTanhRescaling(const OpenMM_AmoebaGeneralizedKirkwoodForce*)</code> */
	public static native int OpenMM_AmoebaGeneralizedKirkwoodForce_getTanhRescaling(PointerByReference target);
	/** Original signature : <code>void OpenMM_AmoebaGeneralizedKirkwoodForce_setTanhRescaling(OpenMM_AmoebaGeneralizedKirkwoodForce*, int)</code> */
	...
	public static native void OpenMM_AmoebaGeneralizedKirkwoodForce_setDielectricOffset(PointerByReference target, double descreenOffet);
