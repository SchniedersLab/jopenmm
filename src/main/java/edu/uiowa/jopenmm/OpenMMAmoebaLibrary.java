...
public class OpenMMAmoebaLibrary implements Library {
	...
	/** Original signature : <code>int OpenMM_AmoebaGeneralizedKirkwoodForce_addParticle_1(OpenMM_AmoebaGeneralizedKirkwoodForce*, double, double, double, double, double)</code> */
	public static native int OpenMM_AmoebaGeneralizedKirkwoodForce_addParticle_1(PointerByReference target, double charge, double radius, double scalingFactor, double descreenRadius, double neckFactor);
	/** Original signature : <code>void OpenMM_AmoebaGeneralizedKirkwoodForce_getParticleParameters(const OpenMM_AmoebaGeneralizedKirkwoodForce*, int, double*, double*, double*, double*, double*)</code> */
	public static native void OpenMM_AmoebaGeneralizedKirkwoodForce_getParticleParameters(PointerByReference target, int index, DoubleBuffer charge, DoubleBuffer radius, DoubleBuffer scalingFactor, DoubleBuffer descreenRadius, DoubleBuffer neckFactor);
	/** Original signature : <code>void OpenMM_AmoebaGeneralizedKirkwoodForce_getParticleParameters(const OpenMM_AmoebaGeneralizedKirkwoodForce*, int, double*, double*, double*, double*, double*)</code> */
	public static native void OpenMM_AmoebaGeneralizedKirkwoodForce_getParticleParameters(PointerByReference target, int index, DoubleByReference charge, DoubleByReference radius, DoubleByReference scalingFactor, DoubleByReference descreenRadius, DoubleByReference neckFactor);
	/** Original signature : <code>void OpenMM_AmoebaGeneralizedKirkwoodForce_setParticleParameters(OpenMM_AmoebaGeneralizedKirkwoodForce*, int, double, double, double, double, double)</code> */
	public static native void OpenMM_AmoebaGeneralizedKirkwoodForce_setParticleParameters(PointerByReference target, int index, double charge, double radius, double scalingFactor, double descreenRadius, double neckFactor);
	...
	/** Original signature : <code>OpenMM_Boolean OpenMM_AmoebaGeneralizedKirkwoodForce_getTanhRescaling(const OpenMM_AmoebaGeneralizedKirkwoodForce*)</code> */
	public static native int OpenMM_AmoebaGeneralizedKirkwoodForce_getTanhRescaling(PointerByReference target);
	/** Original signature : <code>void OpenMM_AmoebaGeneralizedKirkwoodForce_setTanhRescaling(OpenMM_AmoebaGeneralizedKirkwoodForce*, OpenMM_Boolean)</code> */
	public static native void OpenMM_AmoebaGeneralizedKirkwoodForce_setTanhRescaling(PointerByReference target, int tanhRescale);
	/** Original signature : <code>void OpenMM_AmoebaGeneralizedKirkwoodForce_getTanhParameters(const OpenMM_AmoebaGeneralizedKirkwoodForce*, double*, double*, double*)</code> */
	public static native void OpenMM_AmoebaGeneralizedKirkwoodForce_getTanhParameters(PointerByReference target, DoubleBuffer b0, DoubleBuffer b1, DoubleBuffer b2);
	/** Original signature : <code>void OpenMM_AmoebaGeneralizedKirkwoodForce_getTanhParameters(const OpenMM_AmoebaGeneralizedKirkwoodForce*, double*, double*, double*)</code> */
	public static native void OpenMM_AmoebaGeneralizedKirkwoodForce_getTanhParameters(PointerByReference target, DoubleByReference b0, DoubleByReference b1, DoubleByReference b2);
	/** Original signature : <code>void OpenMM_AmoebaGeneralizedKirkwoodForce_setTanhParameters(OpenMM_AmoebaGeneralizedKirkwoodForce*, double, double, double)</code> */
	public static native void OpenMM_AmoebaGeneralizedKirkwoodForce_setTanhParameters(PointerByReference target, double b0, double b1, double b2);
	/** Original signature : <code>double OpenMM_AmoebaGeneralizedKirkwoodForce_getDescreenOffset(const OpenMM_AmoebaGeneralizedKirkwoodForce*)</code> */
	public static native double OpenMM_AmoebaGeneralizedKirkwoodForce_getDescreenOffset(PointerByReference target);
	/** Original signature : <code>void OpenMM_AmoebaGeneralizedKirkwoodForce_setDescreenOffset(OpenMM_AmoebaGeneralizedKirkwoodForce*, double)</code> */
	public static native void OpenMM_AmoebaGeneralizedKirkwoodForce_setDescreenOffset(PointerByReference target, double descreenOffet);
	...
	/** Original signature : <code>double OpenMM_AmoebaGeneralizedKirkwoodForce_getDielectricOffset(const OpenMM_AmoebaGeneralizedKirkwoodForce*)</code> */
	public static native double OpenMM_AmoebaGeneralizedKirkwoodForce_getDielectricOffset(PointerByReference target);
	/** Original signature : <code>void OpenMM_AmoebaGeneralizedKirkwoodForce_setDielectricOffset(OpenMM_AmoebaGeneralizedKirkwoodForce*, double)</code> */
	public static native void OpenMM_AmoebaGeneralizedKirkwoodForce_setDielectricOffset(PointerByReference target, double dielectricOffset);
	...
	/** Original signature : <code>char* OpenMM_AmoebaVdwForce_Lambda(const OpenMM_AmoebaVdwForce*)</code> */
	public static native Pointer OpenMM_AmoebaVdwForce_Lambda(PointerByReference target);
	/** Original signature : <code>void OpenMM_AmoebaVdwForce_setLambdaName(OpenMM_AmoebaVdwForce*, const char*)</code> */
	public static native void OpenMM_AmoebaVdwForce_setLambdaName(PointerByReference target, String name);
	/** Original signature : <code>void OpenMM_AmoebaVdwForce_setLambdaName(OpenMM_AmoebaVdwForce*, const char*)</code> */
	public static native void OpenMM_AmoebaVdwForce_setLambdaName(PointerByReference target, Pointer name);
	...
	/** Original signature : <code>int OpenMM_AmoebaVdwForce_getNumParticleTypes(const OpenMM_AmoebaVdwForce*)</code> */
	public static native int OpenMM_AmoebaVdwForce_getNumParticleTypes(PointerByReference target);
	/** Original signature : <code>int OpenMM_AmoebaVdwForce_getNumTypePairs(const OpenMM_AmoebaVdwForce*)</code> */
	public static native int OpenMM_AmoebaVdwForce_getNumTypePairs(PointerByReference target);
	/** Original signature : <code>void OpenMM_AmoebaVdwForce_setParticleParameters(OpenMM_AmoebaVdwForce*, int, int, double, double, double, OpenMM_Boolean, int, double)</code> */
	public static native void OpenMM_AmoebaVdwForce_setParticleParameters(PointerByReference target, int particleIndex, int parentIndex, double sigma, double epsilon, double reductionFactor, int isAlchemical, int typeIndex, double scaleFactor);
	/** Original signature : <code>void OpenMM_AmoebaVdwForce_getParticleParameters(const OpenMM_AmoebaVdwForce*, int, int*, double*, double*, double*, OpenMM_Boolean*, int*, double*)</code> */
	public static native void OpenMM_AmoebaVdwForce_getParticleParameters(PointerByReference target, int particleIndex, IntBuffer parentIndex, DoubleBuffer sigma, DoubleBuffer epsilon, DoubleBuffer reductionFactor, IntBuffer isAlchemical, IntBuffer typeIndex, DoubleBuffer scaleFactor);
	/** Original signature : <code>void OpenMM_AmoebaVdwForce_getParticleParameters(const OpenMM_AmoebaVdwForce*, int, int*, double*, double*, double*, OpenMM_Boolean*, int*, double*)</code> */
	public static native void OpenMM_AmoebaVdwForce_getParticleParameters(PointerByReference target, int particleIndex, IntByReference parentIndex, DoubleByReference sigma, DoubleByReference epsilon, DoubleByReference reductionFactor, IntByReference isAlchemical, IntByReference typeIndex, DoubleByReference scaleFactor);
	/** Original signature : <code>int OpenMM_AmoebaVdwForce_addParticle(OpenMM_AmoebaVdwForce*, int, double, double, double, OpenMM_Boolean, double)</code> */
	public static native int OpenMM_AmoebaVdwForce_addParticle(PointerByReference target, int parentIndex, double sigma, double epsilon, double reductionFactor, int isAlchemical, double scaleFactor);
	/** Original signature : <code>int OpenMM_AmoebaVdwForce_addParticle_1(OpenMM_AmoebaVdwForce*, int, int, double, OpenMM_Boolean, double)</code> */
	public static native int OpenMM_AmoebaVdwForce_addParticle_1(PointerByReference target, int parentIndex, int typeIndex, double reductionFactor, int isAlchemical, double scaleFactor);
	/** Original signature : <code>int OpenMM_AmoebaVdwForce_addParticleType(OpenMM_AmoebaVdwForce*, double, double)</code> */
	public static native int OpenMM_AmoebaVdwForce_addParticleType(PointerByReference target, double sigma, double epsilon);
	/** Original signature : <code>void OpenMM_AmoebaVdwForce_getParticleTypeParameters(const OpenMM_AmoebaVdwForce*, int, double*, double*)</code> */
	public static native void OpenMM_AmoebaVdwForce_getParticleTypeParameters(PointerByReference target, int typeIndex, DoubleBuffer sigma, DoubleBuffer epsilon);
	/** Original signature : <code>void OpenMM_AmoebaVdwForce_getParticleTypeParameters(const OpenMM_AmoebaVdwForce*, int, double*, double*)</code> */
	public static native void OpenMM_AmoebaVdwForce_getParticleTypeParameters(PointerByReference target, int typeIndex, DoubleByReference sigma, DoubleByReference epsilon);
	/** Original signature : <code>void OpenMM_AmoebaVdwForce_setParticleTypeParameters(OpenMM_AmoebaVdwForce*, int, double, double)</code> */
	public static native void OpenMM_AmoebaVdwForce_setParticleTypeParameters(PointerByReference target, int typeIndex, double sigma, double epsilon);
	/** Original signature : <code>int OpenMM_AmoebaVdwForce_addTypePair(OpenMM_AmoebaVdwForce*, int, int, double, double)</code> */
	public static native int OpenMM_AmoebaVdwForce_addTypePair(PointerByReference target, int type1, int type2, double sigma, double epsilon);
	/** Original signature : <code>void OpenMM_AmoebaVdwForce_getTypePairParameters(const OpenMM_AmoebaVdwForce*, int, int*, int*, double*, double*)</code> */
	public static native void OpenMM_AmoebaVdwForce_getTypePairParameters(PointerByReference target, int pairIndex, IntBuffer type1, IntBuffer type2, DoubleBuffer sigma, DoubleBuffer epsilon);
	/** Original signature : <code>void OpenMM_AmoebaVdwForce_getTypePairParameters(const OpenMM_AmoebaVdwForce*, int, int*, int*, double*, double*)</code> */
	public static native void OpenMM_AmoebaVdwForce_getTypePairParameters(PointerByReference target, int pairIndex, IntByReference type1, IntByReference type2, DoubleByReference sigma, DoubleByReference epsilon);
	/** Original signature : <code>void OpenMM_AmoebaVdwForce_setTypePairParameters(OpenMM_AmoebaVdwForce*, int, int, int, double, double)</code> */
	public static native void OpenMM_AmoebaVdwForce_setTypePairParameters(PointerByReference target, int pairIndex, int type1, int type2, double sigma, double epsilon);
	...
	/** Original signature : <code>OpenMM_Boolean OpenMM_AmoebaVdwForce_getUseParticleTypes(const OpenMM_AmoebaVdwForce*)</code> */
	...
	/** Original signature : <code>OpenMM_AmoebaVdwForce_PotentialFunction OpenMM_AmoebaVdwForce_getPotentialFunction(const OpenMM_AmoebaVdwForce*)</code> */
	public static native int OpenMM_AmoebaVdwForce_getPotentialFunction(PointerByReference target);
	/** Original signature : <code>void OpenMM_AmoebaVdwForce_setPotentialFunction(OpenMM_AmoebaVdwForce*, OpenMM_AmoebaVdwForce_PotentialFunction)</code> */
	public static native void OpenMM_AmoebaVdwForce_setPotentialFunction(PointerByReference target, int potential);
