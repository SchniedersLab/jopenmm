...
public class OpenMMLibrary implements Library {
	...
	/** Original signature : <code>int OpenMM_Integrator_getIntegrationForceGroups(const OpenMM_Integrator*)</code> */
	public static native int OpenMM_Integrator_getIntegrationForceGroups(PointerByReference target);
	/** Original signature : <code>void OpenMM_Integrator_setIntegrationForceGroups(OpenMM_Integrator*, int)</code> */
	public static native void OpenMM_Integrator_setIntegrationForceGroups(PointerByReference target, int groups);
	/**
	...
	/** Original signature : <code>OpenMM_ATMForce* OpenMM_ATMForce_create_2(double, double, double, double, double, double, double, double, double)</code> */
	public static native PointerByReference OpenMM_ATMForce_create_2(double lambda1, double lambda2, double alpha, double uh, double w0, double umax, double ubcore, double acore, double direction);
	...
	/** Original signature : <code>int OpenMM_ATMForce_getNumGlobalParameters(const OpenMM_ATMForce*)</code> */
	public static native int OpenMM_ATMForce_getNumGlobalParameters(PointerByReference target);
	/** Original signature : <code>int OpenMM_ATMForce_getNumEnergyParameterDerivatives(const OpenMM_ATMForce*)</code> */
	public static native int OpenMM_ATMForce_getNumEnergyParameterDerivatives(PointerByReference target);
	/** Original signature : <code>char* OpenMM_ATMForce_getEnergyFunction(const OpenMM_ATMForce*)</code> */
	public static native Pointer OpenMM_ATMForce_getEnergyFunction(PointerByReference target);
	/** Original signature : <code>void OpenMM_ATMForce_setEnergyFunction(OpenMM_ATMForce*, const char*)</code> */
	public static native void OpenMM_ATMForce_setEnergyFunction(PointerByReference target, String energy);
	/** Original signature : <code>void OpenMM_ATMForce_setEnergyFunction(OpenMM_ATMForce*, const char*)</code> */
	public static native void OpenMM_ATMForce_setEnergyFunction(PointerByReference target, Pointer energy);
	/** Original signature : <code>int OpenMM_ATMForce_addForce(OpenMM_ATMForce*, OpenMM_Force*)</code> */
	public static native int OpenMM_ATMForce_addForce(PointerByReference target, PointerByReference force);
	/** Original signature : <code>OpenMM_Force* OpenMM_ATMForce_getForce(const OpenMM_ATMForce*, int)</code> */
	public static native PointerByReference OpenMM_ATMForce_getForce(PointerByReference target, int index);
	/** Original signature : <code>int OpenMM_ATMForce_addParticle(OpenMM_ATMForce*, const OpenMM_Vec3*, const OpenMM_Vec3*)</code> */
	public static native int OpenMM_ATMForce_addParticle(PointerByReference target, OpenMM_Vec3 displacement1, OpenMM_Vec3 displacement0);
	/** Original signature : <code>void OpenMM_ATMForce_getParticleParameters(const OpenMM_ATMForce*, int, OpenMM_Vec3*, OpenMM_Vec3*)</code> */
	public static native void OpenMM_ATMForce_getParticleParameters(PointerByReference target, int index, OpenMM_Vec3 displacement1, OpenMM_Vec3 displacement0);
	/** Original signature : <code>void OpenMM_ATMForce_setParticleParameters(OpenMM_ATMForce*, int, const OpenMM_Vec3*, const OpenMM_Vec3*)</code> */
	public static native void OpenMM_ATMForce_setParticleParameters(PointerByReference target, int index, OpenMM_Vec3 displacement1, OpenMM_Vec3 displacement0);
	/** Original signature : <code>int OpenMM_ATMForce_addGlobalParameter(OpenMM_ATMForce*, const char*, double)</code> */
	public static native int OpenMM_ATMForce_addGlobalParameter(PointerByReference target, String name, double defaultValue);
	/** Original signature : <code>int OpenMM_ATMForce_addGlobalParameter(OpenMM_ATMForce*, const char*, double)</code> */
	public static native int OpenMM_ATMForce_addGlobalParameter(PointerByReference target, Pointer name, double defaultValue);
	/** Original signature : <code>char* OpenMM_ATMForce_getGlobalParameterName(const OpenMM_ATMForce*, int)</code> */
	public static native Pointer OpenMM_ATMForce_getGlobalParameterName(PointerByReference target, int index);
	/** Original signature : <code>void OpenMM_ATMForce_setGlobalParameterName(OpenMM_ATMForce*, int, const char*)</code> */
	public static native void OpenMM_ATMForce_setGlobalParameterName(PointerByReference target, int index, String name);
	/** Original signature : <code>void OpenMM_ATMForce_setGlobalParameterName(OpenMM_ATMForce*, int, const char*)</code> */
	public static native void OpenMM_ATMForce_setGlobalParameterName(PointerByReference target, int index, Pointer name);
	/** Original signature : <code>double OpenMM_ATMForce_getGlobalParameterDefaultValue(const OpenMM_ATMForce*, int)</code> */
	public static native double OpenMM_ATMForce_getGlobalParameterDefaultValue(PointerByReference target, int index);
	/** Original signature : <code>void OpenMM_ATMForce_setGlobalParameterDefaultValue(OpenMM_ATMForce*, int, double)</code> */
	public static native void OpenMM_ATMForce_setGlobalParameterDefaultValue(PointerByReference target, int index, double defaultValue);
	/** Original signature : <code>void OpenMM_ATMForce_addEnergyParameterDerivative(OpenMM_ATMForce*, const char*)</code> */
	public static native void OpenMM_ATMForce_addEnergyParameterDerivative(PointerByReference target, String name);
	/** Original signature : <code>void OpenMM_ATMForce_addEnergyParameterDerivative(OpenMM_ATMForce*, const char*)</code> */
	public static native void OpenMM_ATMForce_addEnergyParameterDerivative(PointerByReference target, Pointer name);
	/** Original signature : <code>char* OpenMM_ATMForce_getEnergyParameterDerivativeName(const OpenMM_ATMForce*, int)</code> */
	public static native Pointer OpenMM_ATMForce_getEnergyParameterDerivativeName(PointerByReference target, int index);
	/** Original signature : <code>void OpenMM_ATMForce_updateParametersInContext(OpenMM_ATMForce*, OpenMM_Context*)</code> */
	public static native void OpenMM_ATMForce_updateParametersInContext(PointerByReference target, PointerByReference context);
	/** Original signature : <code>OpenMM_Boolean OpenMM_ATMForce_usesPeriodicBoundaryConditions(const OpenMM_ATMForce*)</code> */
	public static native int OpenMM_ATMForce_usesPeriodicBoundaryConditions(PointerByReference target);
	/** Original signature : <code>void OpenMM_ATMForce_getPerturbationEnergy(OpenMM_ATMForce*, OpenMM_Context*, double*, double*, double*)</code> */
	public static native void OpenMM_ATMForce_getPerturbationEnergy(PointerByReference target, PointerByReference context, DoubleBuffer u1, DoubleBuffer u0, DoubleBuffer energy);
	/** Original signature : <code>void OpenMM_ATMForce_getPerturbationEnergy(OpenMM_ATMForce*, OpenMM_Context*, double*, double*, double*)</code> */
	public static native void OpenMM_ATMForce_getPerturbationEnergy(PointerByReference target, PointerByReference context, DoubleByReference u1, DoubleByReference u0, DoubleByReference energy);
	...
	/** Original signature : <code>OpenMM_Boolean OpenMM_NonbondedForce_getIncludeDirectSpace(const OpenMM_NonbondedForce*)</code> */
	public static native int OpenMM_NonbondedForce_getIncludeDirectSpace(PointerByReference target);
	/** Original signature : <code>void OpenMM_NonbondedForce_setIncludeDirectSpace(OpenMM_NonbondedForce*, OpenMM_Boolean)</code> */
	public static native void OpenMM_NonbondedForce_setIncludeDirectSpace(PointerByReference target, int include);
	...
	/** Original signature : <code>OpenMM_Boolean OpenMM_NonbondedForce_getExceptionsUsePeriodicBoundaryConditions(const OpenMM_NonbondedForce*)</code> */
	public static native int OpenMM_NonbondedForce_getExceptionsUsePeriodicBoundaryConditions(PointerByReference target);
	/** Original signature : <code>void OpenMM_NonbondedForce_setExceptionsUsePeriodicBoundaryConditions(OpenMM_NonbondedForce*, OpenMM_Boolean)</code> */
	public static native void OpenMM_NonbondedForce_setExceptionsUsePeriodicBoundaryConditions(PointerByReference target, int periodic);
	/**
	 ...
	 * Original signature : <code>OpenMM_LangevinMiddleIntegrator* OpenMM_LangevinMiddleIntegrator_create(double, double, double)</code>
	 */
	public static native PointerByReference OpenMM_LangevinMiddleIntegrator_create(double temperature, double frictionCoeff, double stepSize);
	/** Original signature : <code>void OpenMM_LangevinMiddleIntegrator_destroy(OpenMM_LangevinMiddleIntegrator*)</code> */
	public static native void OpenMM_LangevinMiddleIntegrator_destroy(PointerByReference target);
	/** Original signature : <code>double OpenMM_LangevinMiddleIntegrator_getTemperature(const OpenMM_LangevinMiddleIntegrator*)</code> */
	public static native double OpenMM_LangevinMiddleIntegrator_getTemperature(PointerByReference target);
	/** Original signature : <code>void OpenMM_LangevinMiddleIntegrator_setTemperature(OpenMM_LangevinMiddleIntegrator*, double)</code> */
	public static native void OpenMM_LangevinMiddleIntegrator_setTemperature(PointerByReference target, double temp);
	/** Original signature : <code>double OpenMM_LangevinMiddleIntegrator_getFriction(const OpenMM_LangevinMiddleIntegrator*)</code> */
	public static native double OpenMM_LangevinMiddleIntegrator_getFriction(PointerByReference target);
	/** Original signature : <code>void OpenMM_LangevinMiddleIntegrator_setFriction(OpenMM_LangevinMiddleIntegrator*, double)</code> */
	public static native void OpenMM_LangevinMiddleIntegrator_setFriction(PointerByReference target, double coeff);
	/** Original signature : <code>int OpenMM_LangevinMiddleIntegrator_getRandomNumberSeed(const OpenMM_LangevinMiddleIntegrator*)</code> */
	public static native int OpenMM_LangevinMiddleIntegrator_getRandomNumberSeed(PointerByReference target);
	/** Original signature : <code>void OpenMM_LangevinMiddleIntegrator_setRandomNumberSeed(OpenMM_LangevinMiddleIntegrator*, int)</code> */
	public static native void OpenMM_LangevinMiddleIntegrator_setRandomNumberSeed(PointerByReference target, int seed);
	/** Original signature : <code>void OpenMM_LangevinMiddleIntegrator_step(OpenMM_LangevinMiddleIntegrator*, int)</code> */
	public static native void OpenMM_LangevinMiddleIntegrator_step(PointerByReference target, int steps);
	/**
	...
	/** Original signature : <code>void OpenMM_LocalEnergyMinimizer_minimize(OpenMM_Context*, double, int, OpenMM_MinimizationReporter*)</code> */
	public static native void OpenMM_LocalEnergyMinimizer_minimize(PointerByReference context, double tolerance, int maxIterations, PointerByReference reporter);
	/**
	...
	/** Original signature : <code>OpenMM_Boolean OpenMM_TabulatedFunction_getPeriodic(const OpenMM_TabulatedFunction*)</code> */
	public static native int OpenMM_TabulatedFunction_getPeriodic(PointerByReference target);
	/** Original signature : <code>int OpenMM_TabulatedFunction_getUpdateCount(const OpenMM_TabulatedFunction*)</code> */
	public static native int OpenMM_TabulatedFunction_getUpdateCount(PointerByReference target);
	/**
	 * Continuous1DFunction<br>
	 * Original signature : <code>OpenMM_Continuous1DFunction* OpenMM_Continuous1DFunction_create(const OpenMM_DoubleArray*, double, double, OpenMM_Boolean)</code>
	 */
	public static native PointerByReference OpenMM_Continuous1DFunction_create(PointerByReference values, double min, double max, int periodic);
	 ...
	 * Original signature : <code>OpenMM_MonteCarloFlexibleBarostat* OpenMM_MonteCarloFlexibleBarostat_create(double, double, int, OpenMM_Boolean)</code>
	 */
	public static native PointerByReference OpenMM_MonteCarloFlexibleBarostat_create(double defaultPressure, double defaultTemperature, int frequency, int scaleMoleculesAsRigid);
	/** Original signature : <code>void OpenMM_MonteCarloFlexibleBarostat_destroy(OpenMM_MonteCarloFlexibleBarostat*)</code> */
	...
	/** Original signature : <code>double OpenMM_MonteCarloFlexibleBarostat_getDefaultPressure(const OpenMM_MonteCarloFlexibleBarostat*)</code> */
	public static native double OpenMM_MonteCarloFlexibleBarostat_getDefaultPressure(PointerByReference target);
	/** Original signature : <code>void OpenMM_MonteCarloFlexibleBarostat_setDefaultPressure(OpenMM_MonteCarloFlexibleBarostat*, double)</code> */
	public static native void OpenMM_MonteCarloFlexibleBarostat_setDefaultPressure(PointerByReference target, double pressure);
	/** Original signature : <code>int OpenMM_MonteCarloFlexibleBarostat_getFrequency(const OpenMM_MonteCarloFlexibleBarostat*)</code> */
	public static native int OpenMM_MonteCarloFlexibleBarostat_getFrequency(PointerByReference target);
	/** Original signature : <code>void OpenMM_MonteCarloFlexibleBarostat_setFrequency(OpenMM_MonteCarloFlexibleBarostat*, int)</code> */
	public static native void OpenMM_MonteCarloFlexibleBarostat_setFrequency(PointerByReference target, int freq);
	/** Original signature : <code>double OpenMM_MonteCarloFlexibleBarostat_getDefaultTemperature(const OpenMM_MonteCarloFlexibleBarostat*)</code> */
	public static native double OpenMM_MonteCarloFlexibleBarostat_getDefaultTemperature(PointerByReference target);
	/** Original signature : <code>void OpenMM_MonteCarloFlexibleBarostat_setDefaultTemperature(OpenMM_MonteCarloFlexibleBarostat*, double)</code> */
	public static native void OpenMM_MonteCarloFlexibleBarostat_setDefaultTemperature(PointerByReference target, double temp);
	/** Original signature : <code>int OpenMM_MonteCarloFlexibleBarostat_getRandomNumberSeed(const OpenMM_MonteCarloFlexibleBarostat*)</code> */
	public static native int OpenMM_MonteCarloFlexibleBarostat_getRandomNumberSeed(PointerByReference target);
	/** Original signature : <code>void OpenMM_MonteCarloFlexibleBarostat_setRandomNumberSeed(OpenMM_MonteCarloFlexibleBarostat*, int)</code> */
	public static native void OpenMM_MonteCarloFlexibleBarostat_setRandomNumberSeed(PointerByReference target, int seed);
	/** Original signature : <code>OpenMM_Boolean OpenMM_MonteCarloFlexibleBarostat_usesPeriodicBoundaryConditions(const OpenMM_MonteCarloFlexibleBarostat*)</code> */
	public static native int OpenMM_MonteCarloFlexibleBarostat_usesPeriodicBoundaryConditions(PointerByReference target);
	/** Original signature : <code>OpenMM_Boolean OpenMM_MonteCarloFlexibleBarostat_getScaleMoleculesAsRigid(const OpenMM_MonteCarloFlexibleBarostat*)</code> */
	public static native int OpenMM_MonteCarloFlexibleBarostat_getScaleMoleculesAsRigid(PointerByReference target);
	/** Original signature : <code>void OpenMM_MonteCarloFlexibleBarostat_setScaleMoleculesAsRigid(OpenMM_MonteCarloFlexibleBarostat*, OpenMM_Boolean)</code> */
	public static native void OpenMM_MonteCarloFlexibleBarostat_setScaleMoleculesAsRigid(PointerByReference target, int rigid);
	/**
	 ...
	 * Original signature : <code>OpenMM_Continuous2DFunction* OpenMM_Continuous2DFunction_create(int, int, const OpenMM_DoubleArray*, double, double, double, double, OpenMM_Boolean)</code>
	 */
	public static native PointerByReference OpenMM_Continuous2DFunction_create(int xsize, int ysize, PointerByReference values, double xmin, double xmax, double ymin, double ymax, int periodic);
	...
	/** Original signature : <code>void OpenMM_CustomCVForce_getCollectiveVariableValues(const OpenMM_CustomCVForce*, OpenMM_Context*, OpenMM_DoubleArray*)</code> */
	 ...
	 * Original signature : <code>OpenMM_Continuous3DFunction* OpenMM_Continuous3DFunction_create(int, int, int, const OpenMM_DoubleArray*, double, double, double, double, double, double, OpenMM_Boolean)</code>
	 */
	public static native PointerByReference OpenMM_Continuous3DFunction_create(int xsize, int ysize, int zsize, PointerByReference values, double xmin, double xmax, double ymin, double ymax, double zmin, double zmax, int periodic);
	 ...
	 * Original signature : <code>OpenMM_NoseHooverIntegrator* OpenMM_NoseHooverIntegrator_create(double)</code>
	 */
	public static native PointerByReference OpenMM_NoseHooverIntegrator_create(double stepSize);
	/** Original signature : <code>OpenMM_NoseHooverIntegrator* OpenMM_NoseHooverIntegrator_create_2(double, double, double, int, int, int)</code> */
	public static native PointerByReference OpenMM_NoseHooverIntegrator_create_2(double temperature, double collisionFrequency, double stepSize, int chainLength, int numMTS, int numYoshidaSuzuki);
	/** Original signature : <code>void OpenMM_NoseHooverIntegrator_destroy(OpenMM_NoseHooverIntegrator*)</code> */
	public static native void OpenMM_NoseHooverIntegrator_destroy(PointerByReference target);
	/** Original signature : <code>void OpenMM_NoseHooverIntegrator_step(OpenMM_NoseHooverIntegrator*, int)</code> */
	public static native void OpenMM_NoseHooverIntegrator_step(PointerByReference target, int steps);
	/** Original signature : <code>int OpenMM_NoseHooverIntegrator_addThermostat(OpenMM_NoseHooverIntegrator*, double, double, int, int, int)</code> */
	public static native int OpenMM_NoseHooverIntegrator_addThermostat(PointerByReference target, double temperature, double collisionFrequency, int chainLength, int numMTS, int numYoshidaSuzuki);
	/** Original signature : <code>int OpenMM_NoseHooverIntegrator_addSubsystemThermostat(OpenMM_NoseHooverIntegrator*, const OpenMM_IntArray*, const OpenMM_BondArray*, double, double, double, double, int, int, int)</code> */
	public static native int OpenMM_NoseHooverIntegrator_addSubsystemThermostat(PointerByReference target, PointerByReference thermostatedParticles, PointerByReference thermostatedPairs, double temperature, double collisionFrequency, double relativeTemperature, double relativeCollisionFrequency, int chainLength, int numMTS, int numYoshidaSuzuki);
	/** Original signature : <code>double OpenMM_NoseHooverIntegrator_getTemperature(const OpenMM_NoseHooverIntegrator*, int)</code> */
	public static native double OpenMM_NoseHooverIntegrator_getTemperature(PointerByReference target, int chainID);
	/** Original signature : <code>void OpenMM_NoseHooverIntegrator_setTemperature(OpenMM_NoseHooverIntegrator*, double, int)</code> */
	public static native void OpenMM_NoseHooverIntegrator_setTemperature(PointerByReference target, double temperature, int chainID);
	/** Original signature : <code>double OpenMM_NoseHooverIntegrator_getRelativeTemperature(const OpenMM_NoseHooverIntegrator*, int)</code> */
	public static native double OpenMM_NoseHooverIntegrator_getRelativeTemperature(PointerByReference target, int chainID);
	/** Original signature : <code>void OpenMM_NoseHooverIntegrator_setRelativeTemperature(OpenMM_NoseHooverIntegrator*, double, int)</code> */
	public static native void OpenMM_NoseHooverIntegrator_setRelativeTemperature(PointerByReference target, double temperature, int chainID);
	/** Original signature : <code>double OpenMM_NoseHooverIntegrator_getCollisionFrequency(const OpenMM_NoseHooverIntegrator*, int)</code> */
	public static native double OpenMM_NoseHooverIntegrator_getCollisionFrequency(PointerByReference target, int chainID);
	/** Original signature : <code>void OpenMM_NoseHooverIntegrator_setCollisionFrequency(OpenMM_NoseHooverIntegrator*, double, int)</code> */
	public static native void OpenMM_NoseHooverIntegrator_setCollisionFrequency(PointerByReference target, double frequency, int chainID);
	/** Original signature : <code>double OpenMM_NoseHooverIntegrator_getRelativeCollisionFrequency(const OpenMM_NoseHooverIntegrator*, int)</code> */
	public static native double OpenMM_NoseHooverIntegrator_getRelativeCollisionFrequency(PointerByReference target, int chainID);
	/** Original signature : <code>void OpenMM_NoseHooverIntegrator_setRelativeCollisionFrequency(OpenMM_NoseHooverIntegrator*, double, int)</code> */
	public static native void OpenMM_NoseHooverIntegrator_setRelativeCollisionFrequency(PointerByReference target, double frequency, int chainID);
	/** Original signature : <code>double OpenMM_NoseHooverIntegrator_computeHeatBathEnergy(OpenMM_NoseHooverIntegrator*)</code> */
	public static native double OpenMM_NoseHooverIntegrator_computeHeatBathEnergy(PointerByReference target);
	/** Original signature : <code>int OpenMM_NoseHooverIntegrator_getNumThermostats(const OpenMM_NoseHooverIntegrator*)</code> */
	public static native int OpenMM_NoseHooverIntegrator_getNumThermostats(PointerByReference target);
	/** Original signature : <code>OpenMM_NoseHooverChain* OpenMM_NoseHooverIntegrator_getThermostat(const OpenMM_NoseHooverIntegrator*, int)</code> */
	public static native PointerByReference OpenMM_NoseHooverIntegrator_getThermostat(PointerByReference target, int chainID);
	/** Original signature : <code>OpenMM_Boolean OpenMM_NoseHooverIntegrator_hasSubsystemThermostats(const OpenMM_NoseHooverIntegrator*)</code> */
	public static native int OpenMM_NoseHooverIntegrator_hasSubsystemThermostats(PointerByReference target);
	/** Original signature : <code>double OpenMM_NoseHooverIntegrator_getMaximumPairDistance(const OpenMM_NoseHooverIntegrator*)</code> */
	public static native double OpenMM_NoseHooverIntegrator_getMaximumPairDistance(PointerByReference target);
	/** Original signature : <code>void OpenMM_NoseHooverIntegrator_setMaximumPairDistance(OpenMM_NoseHooverIntegrator*, double)</code> */
	public static native void OpenMM_NoseHooverIntegrator_setMaximumPairDistance(PointerByReference target, double distance);
	/**
	 * OpenMMException<br>
	...
	/** Original signature : <code>int OpenMM_CustomNonbondedForce_getNumComputedValues(const OpenMM_CustomNonbondedForce*)</code> */
	public static native int OpenMM_CustomNonbondedForce_getNumComputedValues(PointerByReference target);
	...
	/** Original signature : <code>int OpenMM_CustomNonbondedForce_addComputedValue(OpenMM_CustomNonbondedForce*, const char*, const char*)</code> */
	public static native int OpenMM_CustomNonbondedForce_addComputedValue(PointerByReference target, String name, String expression);
	/** Original signature : <code>int OpenMM_CustomNonbondedForce_addComputedValue(OpenMM_CustomNonbondedForce*, const char*, const char*)</code> */
	public static native int OpenMM_CustomNonbondedForce_addComputedValue(PointerByReference target, Pointer name, Pointer expression);
	/** Original signature : <code>void OpenMM_CustomNonbondedForce_getComputedValueParameters(const OpenMM_CustomNonbondedForce*, int, char**, char**)</code> */
	public static native void OpenMM_CustomNonbondedForce_getComputedValueParameters(PointerByReference target, int index, PointerByReference name, PointerByReference expression);
	/** Original signature : <code>void OpenMM_CustomNonbondedForce_setComputedValueParameters(OpenMM_CustomNonbondedForce*, int, const char*, const char*)</code> */
	public static native void OpenMM_CustomNonbondedForce_setComputedValueParameters(PointerByReference target, int index, String name, String expression);
	/** Original signature : <code>void OpenMM_CustomNonbondedForce_setComputedValueParameters(OpenMM_CustomNonbondedForce*, int, const char*, const char*)</code> */
	public static native void OpenMM_CustomNonbondedForce_setComputedValueParameters(PointerByReference target, int index, Pointer name, Pointer expression);
	...
	/**
	 * NoseHooverChain<br>
	 * Original signature : <code>OpenMM_NoseHooverChain* OpenMM_NoseHooverChain_create(double, double, double, double, int, int, int, int, int, const OpenMM_IntArray*, const OpenMM_BondArray*)</code>
	 */
	public static native PointerByReference OpenMM_NoseHooverChain_create(double temperature, double relativeTemperature, double collisionFrequency, double relativeCollisionFrequency, int numDOFs, int chainLength, int numMTS, int numYoshidaSuzuki, int chainID, PointerByReference thermostatedAtoms, PointerByReference thermostatedPairs);
	...
	/** Original signature : <code>double OpenMM_NoseHooverChain_getTemperature(const OpenMM_NoseHooverChain*)</code> */
	public static native double OpenMM_NoseHooverChain_getTemperature(PointerByReference target);
	/** Original signature : <code>void OpenMM_NoseHooverChain_setTemperature(OpenMM_NoseHooverChain*, double)</code> */
	public static native void OpenMM_NoseHooverChain_setTemperature(PointerByReference target, double temperature);
	/** Original signature : <code>double OpenMM_NoseHooverChain_getRelativeTemperature(const OpenMM_NoseHooverChain*)</code> */
	public static native double OpenMM_NoseHooverChain_getRelativeTemperature(PointerByReference target);
	/** Original signature : <code>void OpenMM_NoseHooverChain_setRelativeTemperature(OpenMM_NoseHooverChain*, double)</code> */
	public static native void OpenMM_NoseHooverChain_setRelativeTemperature(PointerByReference target, double temperature);
	/** Original signature : <code>double OpenMM_NoseHooverChain_getCollisionFrequency(const OpenMM_NoseHooverChain*)</code> */
	public static native double OpenMM_NoseHooverChain_getCollisionFrequency(PointerByReference target);
	/** Original signature : <code>void OpenMM_NoseHooverChain_setCollisionFrequency(OpenMM_NoseHooverChain*, double)</code> */
	public static native void OpenMM_NoseHooverChain_setCollisionFrequency(PointerByReference target, double frequency);
	/** Original signature : <code>double OpenMM_NoseHooverChain_getRelativeCollisionFrequency(const OpenMM_NoseHooverChain*)</code> */
	public static native double OpenMM_NoseHooverChain_getRelativeCollisionFrequency(PointerByReference target);
	/** Original signature : <code>void OpenMM_NoseHooverChain_setRelativeCollisionFrequency(OpenMM_NoseHooverChain*, double)</code> */
	public static native void OpenMM_NoseHooverChain_setRelativeCollisionFrequency(PointerByReference target, double frequency);
	/** Original signature : <code>int OpenMM_NoseHooverChain_getNumDegreesOfFreedom(const OpenMM_NoseHooverChain*)</code> */
	public static native int OpenMM_NoseHooverChain_getNumDegreesOfFreedom(PointerByReference target);
	/** Original signature : <code>void OpenMM_NoseHooverChain_setNumDegreesOfFreedom(OpenMM_NoseHooverChain*, int)</code> */
	public static native void OpenMM_NoseHooverChain_setNumDegreesOfFreedom(PointerByReference target, int numDOF);
	/** Original signature : <code>int OpenMM_NoseHooverChain_getChainLength(const OpenMM_NoseHooverChain*)</code> */
	public static native int OpenMM_NoseHooverChain_getChainLength(PointerByReference target);
	/** Original signature : <code>int OpenMM_NoseHooverChain_getNumMultiTimeSteps(const OpenMM_NoseHooverChain*)</code> */
	public static native int OpenMM_NoseHooverChain_getNumMultiTimeSteps(PointerByReference target);
	/** Original signature : <code>int OpenMM_NoseHooverChain_getNumYoshidaSuzukiTimeSteps(const OpenMM_NoseHooverChain*)</code> */
	public static native int OpenMM_NoseHooverChain_getNumYoshidaSuzukiTimeSteps(PointerByReference target);
	/** Original signature : <code>int OpenMM_NoseHooverChain_getChainID(const OpenMM_NoseHooverChain*)</code> */
	public static native int OpenMM_NoseHooverChain_getChainID(PointerByReference target);
	/** Original signature : <code>OpenMM_IntArray* OpenMM_NoseHooverChain_getThermostatedAtoms(const OpenMM_NoseHooverChain*)</code> */
	public static native PointerByReference OpenMM_NoseHooverChain_getThermostatedAtoms(PointerByReference target);
	/** Original signature : <code>void OpenMM_NoseHooverChain_setThermostatedAtoms(OpenMM_NoseHooverChain*, const OpenMM_IntArray*)</code> */
	public static native void OpenMM_NoseHooverChain_setThermostatedAtoms(PointerByReference target, PointerByReference atomIDs);
	/** Original signature : <code>OpenMM_BondArray* OpenMM_NoseHooverChain_getThermostatedPairs(const OpenMM_NoseHooverChain*)</code> */
	public static native PointerByReference OpenMM_NoseHooverChain_getThermostatedPairs(PointerByReference target);
	/** Original signature : <code>void OpenMM_NoseHooverChain_setThermostatedPairs(OpenMM_NoseHooverChain*, const OpenMM_BondArray*)</code> */
	public static native void OpenMM_NoseHooverChain_setThermostatedPairs(PointerByReference target, PointerByReference pairIDs);
	/** Original signature : <code>OpenMM_Boolean OpenMM_NoseHooverChain_usesPeriodicBoundaryConditions(const OpenMM_NoseHooverChain*)</code> */
	public static native int OpenMM_NoseHooverChain_usesPeriodicBoundaryConditions(PointerByReference target);
	/**
	 * System<br>
	 ...
	 * Original signature : <code>OpenMM_MinimizationReporter* OpenMM_MinimizationReporter_create()</code>
	 */
	public static native PointerByReference OpenMM_MinimizationReporter_create();
	/** Original signature : <code>void OpenMM_MinimizationReporter_destroy(OpenMM_MinimizationReporter*)</code> */
	public static native void OpenMM_MinimizationReporter_destroy(PointerByReference target);
	/** Original signature : <code>OpenMM_Boolean OpenMM_MinimizationReporter_report(OpenMM_MinimizationReporter*, int, const OpenMM_DoubleArray*, const OpenMM_DoubleArray*, OpenMM_ParameterArray*)</code> */
	public static native int OpenMM_MinimizationReporter_report(PointerByReference target, int iteration, PointerByReference x, PointerByReference grad, PointerByReference args);
	/**
