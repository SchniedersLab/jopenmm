...
public class OpenMMAmoebaLibrary implements Library {
  ...
  /**
   * Original signature : <code>char* OpenMM_AmoebaVdwForce_Lambda(const OpenMM_AmoebaVdwForce*)
   * </code>
   */
  public static native Pointer OpenMM_AmoebaVdwForce_Lambda(PointerByReference target);
  /**
   * Original signature : <code>
   * void OpenMM_AmoebaVdwForce_setLambdaName(OpenMM_AmoebaVdwForce*, const char*)</code>
   */
  public static native void OpenMM_AmoebaVdwForce_setLambdaName(
